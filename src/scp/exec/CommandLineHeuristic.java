...
public class CommandLineHeuristic implements IHeuristicResultCallback {
	...
	private void save() throws JAXBException, FileNotFoundException {
		...
		bridge.setPlacedShapeList(placedShapeList);
	...
	public static void main(String[] args) {
		...
		CommandLineHeuristic clh = null;
		
		try {
			clh = new CommandLineHeuristic();
			clh.configure(args);
